import { parseGenToWei, formatWeiToGen, sanitizeGenInput, tiersAreDescending } from '../money.js';
...
function runUnitConversionTests() {
  ...
  assert(tiersAreDescending(1000n, 500n, 200n, 100n) === true, 'descending tiers ok');
  assert(tiersAreDescending(100n, 200n, 50n, 10n) === false, 'inverted tiers blocked');
  assert(tiersAreDescending(100n, 50n, 20n, 0n) === false, 'zero tier blocked');
